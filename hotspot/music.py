...
# time.sleep(100)
def get_data(roonapid, interface): 
  ...
  def render(draw, width, height):
      ...
      try: 
        for zone in roonapid.zones:
            if roonapid.zones[zone]['display_name'] == interface:
                dac_zone=zone
                ...
                title_text(draw, margin, width, "%s Playing" % interface )
        ...
        title_text(draw, margin, width, "%s not playing" % interface )
  return render
